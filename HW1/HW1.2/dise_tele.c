...
void dise_tele(){
    ...
    tree->Branch("de1", &de1_blur, "de1/D");
    ...
    for(int j = 0; j < 1000; j ++){
        ...
        for(int i =0; i < 1000; i++){
            ...
            de1_blur = ran->Gaus(de1, 10*0.01/2.35*sqrt(5*de1));
        
            double E2_he = E1_he - de1;
            de2 = de_thick(res, A, E2_he, 0.5, e_x_he, x_e_he);
            de2_blur = ran->Gaus(de2, 10*0.01/2.35*sqrt(5*de2));
        
            double E3_he = E2_he - de2;
            de3 = de_thick(res, A, E3_he, 1, e_x_he, x_e_he);
            de3_blur = ran->Gaus(de3, 10*0.01/2.35*sqrt(5*de3));
    ...
    TFile *new_f = new TFile("dise_tele_10.root", "READ");
